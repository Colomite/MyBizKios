package com.kreators.mybizkios.report.holder;
...
import com.kreators.mybizkios.report.TableViewModel;
...
public class ColumnHeaderViewHolder extends AbstractSorterViewHolder
{
    ...
    public void setColumnHeaderModel(ColumnHeaderModel pColumnHeaderModel, int pColumnPosition) {
        ...
        column_header_textview.setGravity(TableViewModel.getColumnTextAlign(pColumnPosition) | Gravity
                .CENTER_VERTICAL);
    ...
    public void setSelected(SelectionState p_nSelectionState) {
        ...
        if (p_nSelectionState == SelectionState.SELECTED) {
            ...
            nForegroundColorId = R.color.background_dataheader_colour;
